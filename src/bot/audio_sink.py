...
class ElevenLabsAudioSink:
    """
    Audio sink that captures Discord voice audio and sends it to ElevenLabs.
...
def create_audio_sink(
    ...
    """
    if HAS_VOICE_RECV:
        return ElevenLabsAudioSink(on_audio, target_user_id)
    else:
