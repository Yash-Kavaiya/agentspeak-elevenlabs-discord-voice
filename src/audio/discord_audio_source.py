"""Discord audio source for playing ElevenLabs audio."""
...
class ElevenLabsAudioSource(discord.AudioSource):
    """
    Audio source that streams ElevenLabs audio to Discord.
...
class StreamingAudioSource(discord.AudioSource):
    ...
    Useful for real-time audio streaming from ElevenLabs WebSocket.
    """
